...
namespace GlassLP.Services
{
    public class CampService : ICampService
    {
        ...
        //    return await _context.TblCamp.FindAsync(id);
        //}
        ////public DataTable GetCampList()
        ////{
        ////    return _spManager.SP_CampList();
        ////}

        ////public DataTable GetCampm2List()
        ////{
        ////    return _spManager.SP_CampList(); // Note: This seems to be the same as Campm1List based on the controller
        ////}
