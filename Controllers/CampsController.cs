...
namespace GlassLP.Controllers
{
	public class CampsController : BaseController
	{
		...
		int result = 0;
		public CampsController(GlassDbContext context, ICompositeViewEngine viewEngine, SPManager spManager, CommonData commonData, GlobalDataService globalData)
		{
			_context = context;
		...
		public Result GetCampList(Filtermodel filtermodel)
		{
			try
			{
				...
				if (tbllist.Rows.Count > 0)
				{
					...
					string html = RenderPartialViewToString("_CampData", tbllist);
